...
### Next (v0.3 P1 — インタラクション強化)

目標: 「触って理解できる」— Direct Manipulation の完成

- [ ] Point Info (カーソルホバーで緯度・経度・値を Inspector に表示)
- [ ] Profile ビュー (特定地点の鉛直プロファイル / 時系列グラフ)
- [ ] キーボードショートカット (Space=再生, ←→=時間, ↑↓=レベル, 1-6=ビュー切替)

### Next (v0.3 P2)
- [ ] Polar Stereographic 投影
- [ ] ストリームライン描画
- [ ] Zonal Mean トグル (断面ビュー)
- [ ] 等値線オーバーレイ
