...
### Next (v0.4 — アノテーション + コード生成)
- [ ] Visualization Suggestion (描画サジェスト、推論エンジン拡張) — Issue #7
- [ ] アノテーションレイヤー (NetCDF 1D 軌跡 + 外部 JSON/CSV) — Issue #8
- [ ] Code Panel (GUI → Python コード生成) — Issue #9
- [ ] GIF/MP4 エクスポート
