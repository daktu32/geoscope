...
- [x] ロゴデザイン (案B: Scope 強調型を採用)
  - コンセプト: 「レンズ越しに球面上の流体データを観測する」
  - 地球儀 (ティール) + レンズ (白/黒) + 渦度ダイポール (赤青)
  - Scope 効果: レンズ外は薄く、レンズ内は鮮明
  - 渦度は地球儀 × レンズの二重クリップで正しく表示
  - カラーパレット: `#2AA198` / `#E63946` / `#5AAAC8`
  - ダーク版・ライト版の2バリエーション
  - 別 LLM によるデザインレビュー実施、3案比較の上で案B採用

### Next Steps
- [ ] ロゴの最終調整・エクスポート (SVG/PNG)
- [ ] README にロゴ埋め込み
